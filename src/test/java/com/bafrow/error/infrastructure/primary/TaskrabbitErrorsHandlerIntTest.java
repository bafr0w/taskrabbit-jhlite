...
import com.bafrow.IntegrationTest;

@IntegrationTest
@AutoConfigureMockMvc
class TaskrabbitErrorsHandlerIntTest {

  @Autowired
  private MockMvc rest;

  @Test
  void shouldHandleTaskrabbitErrorWithoutLocale() throws Exception {
    rest
  ...
  @Test
  void shouldHandleTaskrabbitErrorForFrenchLocale() throws Exception {
    rest
