...
import static com.bafrow.kipe.application.TestAuthentications.*;
import static com.bafrow.kipe.domain.RolesAccessesFixture.*;
...
import com.bafrow.kipe.domain.RolesAccessesFixture.TestResource;
...
@UnitTest
class TaskrabbitAuthorizationsTest {

  private static final TaskrabbitAuthorizations authorizations = new TaskrabbitAuthorizations(List.of(rolesAccesses()));
